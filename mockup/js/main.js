 ...
 $(function () {
    ...
    // show and hide side panel to select line chart data
    $("#hideLinePanel").click(function () {
      $("#chartLine").toggle();
      $("#hideLinePanel").toggle();
      $("#showLinePanel").toggle();
    });
    $("#showLinePanel").click(function () {
      $("#chartLine").toggle();
      $("#hideLinePanel").toggle();
      $("#showLinePanel").toggle();
    });
...
chart.legend = new am4charts.Legend();
  ...
  am4core.ready(function () {
    ...
    /* Create chart instance */
    var chart = am4core.create("radar-t1", am4charts.RadarChart);
    /* Create chart instance */
    var chartEnergy = am4core.create("radar-t2", am4charts.RadarChart);
    /* Create chart instance */
    var chartEnergyCit = am4core.create("radar-t3", am4charts.RadarChart);
